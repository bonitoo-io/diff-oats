...
export interface CheckBase {
  ...
  description?: string
  /** A timestamp ([RFC3339 date/time format](https://docs.influxdata.com/influxdb/cloud/reference/glossary/#rfc3339-timestamp)) of the latest scheduled and completed run. */
...
/**
 * Represents an instant in time with nanosecond precision in [RFC3339Nano date/time format](https://docs.influxdata.com/influxdb/cloud/reference/glossary/#rfc3339nano-timestamp).
 */
...
export interface Run {
  ...
  /** The time [RFC3339 date/time format](https://docs.influxdata.com/influxdb/cloud/reference/glossary/#rfc3339-timestamp) used for the run's `now` option. */
  scheduledFor?: string
  ...
  /** The time ([RFC3339Nano date/time format](https://docs.influxdata.com/influxdb/cloud/reference/glossary/#rfc3339nano-timestamp)) the run was manually requested. */
...
export interface LogEvent {
  /** The time ([RFC3339Nano date/time format](https://docs.influxdata.com/influxdb/cloud/reference/glossary/#rfc3339nano-timestamp)) that the event occurred. */
...
/**
 * A list of measurement schemas returning summary information
 */
export interface MeasurementSchemaList {
  measurementSchemas: MeasurementSchema[]
}

/**
 * Definition of a measurement schema.
 */
...
/**
 * Definition of a measurement schema column.
 */
export interface MeasurementSchemaColumn {
  name: string
  type: ColumnSemanticType
  dataType?: ColumnDataType
}

export type ColumnSemanticType = 'timestamp' | 'tag' | 'field'
 ...
 */
export interface MeasurementSchemaCreateRequest {
  name: string
  /** Ordered collection of column definitions. */
  columns: MeasurementSchemaColumn[]
}
 ...
 */
export interface MeasurementSchemaUpdateRequest {
 ...
 */
  flux?: string
  /** The interval ([duration literal](https://docs.influxdata.com/influxdb/cloud/reference/glossary/#rfc3339-timestamp)) at which the task runs. `every` also determines when the task first runs, depending on the specified time. */
  every?: string
...
export interface GetBucketsSchemaMeasurementsParams {
  bucketID: string
...
type GetBucketsSchemaMeasurementsResult =
  | GetBucketsSchemaMeasurementsOKResult
  | GetBucketsSchemaMeasurementsNotFoundResult

interface GetBucketsSchemaMeasurementsOKResult {
  status: 200
  headers: Headers
  data: MeasurementSchemaList
}

interface GetBucketsSchemaMeasurementsNotFoundResult {
  status: 404
  headers: Headers
  data: Error
}

export const getBucketsSchemaMeasurements = (
  params: GetBucketsSchemaMeasurementsParams,
  options: RequestOptions = {}
): Promise<GetBucketsSchemaMeasurementsResult> =>
  request(
    'GET',
    `/api/v2/buckets/${params.bucketID}/schema/measurements`,
    params,
    options
  ) as Promise<GetBucketsSchemaMeasurementsResult>

export interface PostBucketsSchemaMeasurementParams {
  bucketID: string

  data?: MeasurementSchemaCreateRequest
...
type PostBucketsSchemaMeasurementResult =
  | PostBucketsSchemaMeasurementCreatedResult
  | PostBucketsSchemaMeasurementBadRequestResult

interface PostBucketsSchemaMeasurementCreatedResult {
  status: 201
  headers: Headers
  data: MeasurementSchema
}

interface PostBucketsSchemaMeasurementBadRequestResult {
  status: 400
  headers: Headers
  data: Error
}

export const postBucketsSchemaMeasurement = (
  params: PostBucketsSchemaMeasurementParams,
  options: RequestOptions = {}
): Promise<PostBucketsSchemaMeasurementResult> =>
  request(
    'POST',
    `/api/v2/buckets/${params.bucketID}/schema/measurements`,
    {...params, headers: {'Content-Type': 'application/json'}},
    options
  ) as Promise<PostBucketsSchemaMeasurementResult>

export interface GetBucketsSchemaMeasurementParams {
  bucketID: string
...
type GetBucketsSchemaMeasurementResult = GetBucketsSchemaMeasurementOKResult

interface GetBucketsSchemaMeasurementOKResult {
  status: 200
  headers: Headers
  data: MeasurementSchema
}

export const getBucketsSchemaMeasurement = (
  params: GetBucketsSchemaMeasurementParams,
  options: RequestOptions = {}
): Promise<GetBucketsSchemaMeasurementResult> =>
  request(
    'GET',
    `/api/v2/buckets/${params.bucketID}/schema/measurements/${params.measurementID}`,
    params,
    options
  ) as Promise<GetBucketsSchemaMeasurementResult>

export interface PatchBucketsSchemaMeasurementParams {
  bucketID: string
  measurementID: string

  data?: MeasurementSchemaUpdateRequest
...
type PatchBucketsSchemaMeasurementResult =
  | PatchBucketsSchemaMeasurementOKResult
  | PatchBucketsSchemaMeasurementBadRequestResult

interface PatchBucketsSchemaMeasurementOKResult {
  status: 200
  headers: Headers
  data: MeasurementSchema
}

interface PatchBucketsSchemaMeasurementBadRequestResult {
  status: 400
  headers: Headers
  data: Error
}

export const patchBucketsSchemaMeasurement = (
  params: PatchBucketsSchemaMeasurementParams,
  options: RequestOptions = {}
): Promise<PatchBucketsSchemaMeasurementResult> =>
  request(
    'PATCH',
    `/api/v2/buckets/${params.bucketID}/schema/measurements/${params.measurementID}`,
    {...params, headers: {'Content-Type': 'application/json'}},
    options
  ) as Promise<PatchBucketsSchemaMeasurementResult>
...
export const getOrgsLimits = (
  ...
  request(
    'GET',
    `/api/v2/orgs/${params.orgID}/limits`,
    params,
    options
  ) as Promise<GetOrgsLimitsResult>

export interface GetOrgsUsageParams {
  orgID: string
...
type GetOrgsUsageResult = GetOrgsUsageOKResult | GetOrgsUsageDefaultResult

interface GetOrgsUsageOKResult {
  status: 200
  headers: Headers
  data: string
}

interface GetOrgsUsageDefaultResult {
  status: 500
  headers: Headers
  data: Error
}

export const getOrgsUsage = (
  params: GetOrgsUsageParams,
  options: RequestOptions = {}
): Promise<GetOrgsUsageResult> =>
  request(
    'GET',
    `/api/v2/orgs/${params.orgID}/usage`,
    params,
    options
  ) as Promise<GetOrgsUsageResult>
